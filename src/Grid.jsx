...
export default class Grid extends React.Component {
  ...
  renderLeftPaneHeader() {
    ...
    return (
      ...
      >
        <div
          className={cx(styles.leftPaneHeaderContent)}
          style={contentStyle}
        ...
        >
          {this.renderCellRange(
            "left-pane-header",
            0,
            this.props.fixedHeaderCount - 1,
            0,
            this.props.fixedLeftColumnCount - 1,
  ...
  renderLeftPaneFooter() {
    ...
    const fromRow =
      this.props.rowCount > 0
        ? this.props.rowCount - this.props.fixedFooterCount
        : 0;
    ...
    return (
      ...
      >
        <div
          className={cx(styles.leftPaneFooterContent)}
          style={contentStyle}
  ...
  renderLeftPaneBody() {
    ...
    return (
      ...
      >
        <div
          className={cx(styles.leftPaneBodyContent)}
          style={contentStyle}
  ...
  renderRightPaneFooter() {
    if (
      !this.state.cells ||
      this.props.fixedRightColumnCount < 1 ||
      this.props.fixedFooterCount < 1
    ) {
      return null;
    }
    ...
    const fromColumn =
      this.props.columnCount > 0
        ? this.props.columnCount - this.props.fixedRightColumnCount
        : 0;
    const toColumn = fromColumn
      ? fromColumn + this.props.fixedRightColumnCount - 1
      : null;
    ...
    return (
      ...
      >
        <div
          className={cx(styles.rightPaneFooterContent)}
          style={contentStyle}
  ...
  renderRightPaneBody() {
    ...
    return (
      ...
      >
        <div
          className={cx(styles.rightPaneBodyContent)}
          style={contentStyle}
  ...
  renderCenterPaneHeader() {
    ...
    return (
      ...
      >
        <div
          className={cx(styles.centerPaneHeaderContent)}
          style={contentStyle}
  ...
  renderCenterPaneBody() {
    ...
    return (
      ...
      >
        <div
          className={cx(styles.centerPaneBodyContent)}
          style={contentStyle}
  ...
  update(scrollTop, scrollLeft, force, props) {
    ...
    const bounds = {
      ...
      top: Math.max(0, y),
      width:
        this._root.clientWidth + 2 * props.preloadPixelsX + (x < 0 ? x : 0),
      height:
        this._root.clientHeight + 2 * props.preloadPixelsY + (y < 0 ? y : 0),
    };
  ...
  renderCellRange(pane, fromRow, toRow, fromColumn, toColumn, rows, columns) {
    ...
    for (
      let row = toRow, visibleRowIndex = -1;
      row >= fromRow;
      --row, ++visibleRowIndex
    ) {
      const rowCells = [];
      ...
      for (
        let column = toColumn, visibleColumnIndex = -1;
        column >= fromColumn;
